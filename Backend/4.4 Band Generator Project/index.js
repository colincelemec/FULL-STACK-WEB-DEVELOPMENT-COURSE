...
let copyright = "Copyright © " + year_date
...
app.post("/submit", (req, res) => {
  ...
  //scroll down to see the two arrays.
    let random_adj = Math.floor(Math.random(0,adj.length)) + 1
    let name_adj = adj[random_adj]

    let random_noun = Math.floor(Math.random(0,noun.length)) + 1
    let name_noun = adj[random_noun]

    let Generate_Name = name_adj + " " + name_noun
  
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render

  res.render("index.ejs", Generate_Name, copyright)
